...
helpers.sendEmail=(to, body,callback)=>{
    ...
    const payload={
        'from': 'mailgun@sandbox16332fcfa31c4562a0e6e17dd8a6abd2.mailgun.org',
        'to': to,
    ...
    const requestDetails={
        ...
        'method':'POST',
        'path':'/v3/sandbox16332fcfa31c4562a0e6e17dd8a6abd2.mailgun.org/messages',
        'auth': 'api:353c0dcbe9982d348e9c9db48d603094-e49cc42c-7c0ee717',
        'headers':{
            'Content-Type': 'application/x-www-form-urlencoded',
            'Content-Length': Buffer.byteLength(stringPayLoad)
        }
